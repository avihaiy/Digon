...
export type SlideId = "heichal" | "memorial" | "zmanim" | "finance" | "vort" | "announcements" | "omer";
...
const SLIDE_LABELS: Record<SlideId, { label: string; emoji: string; desc: string }> = {
  ...
  omer: { label: "ספירת העומר", emoji: "🌾", desc: "מונה אוטומטי לעומר" },
...
const DEFAULT_ORDER: SlideId[] = ["heichal", "memorial", "omer", "zmanim", "finance", "vort", "announcements"];
