...
import { Fish, MapPin, Wind, Waves, Camera, Plus, Clock, ChevronRight, ChevronLeft, RefreshCw, Activity, Link2, Settings2, Scale, Radar as RadarIcon, Package, Store as StoreIcon, Video, ShoppingCart, AlertTriangle, Droplets } from 'lucide-react';
    ...
    <div className="space-y-6 pb-20 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-lg mx-auto">
      ...
      <section className="pt-2 pl-0 pr-4">
        ...
        <div className="relative group/actions">
          <button onClick={() => scrollQuickActions('right')} className="absolute -right-2 top-1/2 -translate-y-[60%] z-10 bg-white dark:bg-slate-800 shadow-md border border-slate-200 dark:border-slate-700 p-1.5 rounded-full text-blue-600 dark:text-blue-400 transition-all hover:scale-110 active:scale-95 opacity-90 hover:opacity-100 flex">
