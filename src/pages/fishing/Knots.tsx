...
const KNOTS_DB = [
  ...
  {
    id: "double-uni",
    name: "קשר יוני כפול (Double Uni Knot)",
    difficulty: "קל",
    useCase: "חיבור שני חוטים יחד (בד לניילון/פלורו)",
    color: "bg-emerald-500/10 text-emerald-500",
    desc: "אלטרנטיבה קלה ומהירה לקשר FG. מעולה לחיבור חוט בד (Braid) לחוט שוק-לידר. אמנם הקשר מעט עבה מ-FG, אך הוא פשוט, אמין וקל לקשירה בשטח.",
    steps: [
      "הניחו את שני החוטים (הבד והפלורו) במקביל זה לזה כשהם חופפים בכ-20 ס״מ.",
      "קחו את קצה חוט הפלורו, צרו לולאה, ולפפו את הקצה סביב שני החוטים בתוך הלולאה 5 פעמים.",
      "הדקו את הקשר שנוצר (פלורו).",
      "חזרו על הפעולה עם חוט הבד: צרו לולאה, ולפפו את קצה חוט הבד סביב שני החוטים 7-8 פעמים.",
      "הדקו את קשר הבד.",
      "כעת, משכו את שני החוטים הראשיים בכיוונים מנוגדים כך ששני הקשרים יחליקו וייתקעו אחד בשני.",
      "חתכו את שתי השאריות קרוב לקשר."
    ]
  },
  {
    id: "snell",
    name: "קשר סנל / קרס כפותה (Snell Knot)",
    difficulty: "בינוני",
    useCase: "קשירת קרס עם כף (ללא טבעת) או ליישור הקרס",
    color: "bg-yellow-500/10 text-yellow-600",
    desc: "הקשר המושלם לקרסים כפותות (Spade end) או לקרסים עם טבעת כשרוצים שהקרס תעמוד בקו ישר בדיוק עם החוט להוק-סט (נעיצה) מושלם.",
    steps: [
      "העבירו את החוט דרך טבעת הקרס (אם יש) והצמידו את קצה החוט לאורך גב הקרס.",
      "צרו לולאה גדולה עם החוט כך שהקצה פונה חזרה לכיוון הטבעת.",
      "התחילו ללפף את החוט סביב צוואר הקרס (והחוט הצמוד אליו) מתוך הלולאה, 6-8 פעמים.",
      "ודאו שהליפופים מסודרים יפה אחד ליד השני ולא עולים אחד על השני.",
      "החזיקו את הליפופים במקום ומשכו את החוט הראשי כדי להדק את הקשר.",
      "חתכו את שארית החוט."
    ]
  },
  {
    id: "blood",
    name: "קשר דם (Blood Knot)",
    difficulty: "קשה",
    useCase: "חיבור שני חוטים בעלי עובי דומה (מונו למונו)",
    color: "bg-rose-500/10 text-rose-500",
    desc: "קשר קלאסי, חזק ונקי מאוד לחיבור שני חוטים זהים. שימושי מאוד לתיקון חוט שנקרע או לחיבור חוטים ברולר. לא מתאים לחיבור חוטי בד (Braid).",
    steps: [
      "הצליבו את שני החוטים במרכזם.",
      "לפפו את קצה חוט א' סביב חוט ב' 5 פעמים, והחזירו את הקצה אחורה דרך נקודת ההצטלבות האמצעית.",
      "לפפו את קצה חוט ב' סביב חוט א' 5 פעמים, והחזירו את הקצה אחורה דרך אותה נקודת הצטלבות, אך בכיוון הנגדי לקצה א'.",
      "הרטבו היטב את החוטים.",
      "משכו את שני החוטים הראשיים בעדינות ובמקביל כדי שהקשר יתהדק ויסתלסל בצורה סימטרית ויפה.",
      "חתכו את השאריות ממש קרוב לקשר."
    ]
  },
  {
    id: "arbor",
    name: "קשר רולר (Arbor Knot)",
    difficulty: "קל",
    useCase: "קשירת חוט חדש לתוף הרולר (Spool)",
    color: "bg-blue-500/10 text-blue-500",
    desc: "הקשר הראשון שכל דייג צריך לדעת. משמש לקשירת חוט הדיג לתוף של הרולר לפני שמגלגלים עליו את החוט. קשר פשוט שננעל על עצמו.",
    steps: [
      "העבירו את החוט מסביב לתוף (Spool) של הרולר.",
      "עשו קשר סבתא (Overhand) עם הקצה סביב החוט הראשי (כמו לולאת חנק).",
      "כדי למנוע מהקצה להחליק, עשו קשר סבתא נוסף ממש בקצה החוט.",
      "משכו את החוט הראשי. הקשר הראשון יחליק עד התוף, והקשר השני ישמש כ'מעצור' שימנע ממנו להיפתח.",
      "משכו חזק עד שהקשר ננעל בחוזקה על התוף וחתכו את השארית הקטנה."
    ]
  }
];
