...
async function addAttribute() {
    console.log("Adding is_flared to catches_...");
    try {
        await databases.createBooleanAttribute('6a674a380025507f9db2', 'catches_', 'is_flared', false, false);
        console.log("Added is_flared!");
