...
BEGIN
  ...
  SELECT value INTO paybox_phone FROM public.app_settings WHERE key = 'paybox_phone';
  SELECT value INTO paybox_enabled FROM public.app_settings WHERE key = 'paybox_enabled';
  ...
  RETURN jsonb_build_object(
    ...
    'paybox_phone', COALESCE(paybox_phone, ''),
    'paybox_enabled', COALESCE(paybox_enabled, 'false') = 'true',
