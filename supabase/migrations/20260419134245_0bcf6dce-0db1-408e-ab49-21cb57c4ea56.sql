-- Update event reminder trigger to read configurable hours-before from app_settings
...
DECLARE
  ...
  prefix_label TEXT;
BEGIN
  -- Read configurable hours-before from app_settings (default: 24)
  ...
  -- Compute reminder time: N hours before event start
